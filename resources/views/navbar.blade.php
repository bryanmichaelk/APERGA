...
>
  <div class="flex container-xl justify-between items-center h-full">
    <div class="p-auto">
      <img src="{{ asset('img/Logo.png') }}" width="171" height="0" alt="Logo" />
    </div>
    <div class="flex item-center space-x-8">
      ...
      >
        ...
        <div class="flex item-center space-x-4">
          <a href="/" class="btn btn-outline mid px-[22px] py-2 rounded-[8px] border-[#135589] border-2 text-[#135589] text-center font-medium">
            Daftar
          </a>
          <a href="/" class="btn btn-primary mid px-[22px] py-2 rounded-[8px] bg-[#135589] text-[#ffffff] text-center font-medium">
            Masuk
          </a>
        </div>
      </div>
